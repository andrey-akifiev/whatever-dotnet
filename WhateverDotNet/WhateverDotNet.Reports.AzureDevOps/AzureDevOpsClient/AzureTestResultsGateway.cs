...
public class AzureTestResultsGateway(AzureDevOpsService azureDevOpsService, ILoggerFactory? loggerFactory)
    : BaseAzureDevOpsGateway<TestResultsHttpClient>(azureDevOpsService)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            ...
            List<TestCaseResult>? response = await Client
