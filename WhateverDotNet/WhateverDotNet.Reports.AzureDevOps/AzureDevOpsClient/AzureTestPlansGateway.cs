...
public class AzureTestPlansGateway(AzureDevOpsService azureDevOpsService, ILoggerFactory? loggerFactory)
    : BaseAzureDevOpsGateway<TestPlanHttpClient>(azureDevOpsService)
{
    private readonly ILogger<AzureTestPlansGateway>? _logger = loggerFactory?.CreateLogger<AzureTestPlansGateway>();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            PagedList<TestConfiguration> response = await Client
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            PagedList<TestVariable> response = await Client
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            PagedList<TestCase> response = await Client
    ...
    public async Task<TestPlan> GetTestPlanByNameAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        PagedList<TestPlan>? testPlans = await Client
            .GetTestPlansAsync(
                project: projectName,
                cancellationToken: cancellationToken)
            .ConfigureAwait(false);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            PagedList<TestPlan> response = await Client
                .GetTestPlansAsync(
                    project: projectName,
                    continuationToken: continuationToken,
                    cancellationToken: cancellationToken)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            PagedList<TestPoint> response = await Client
                .GetPointsListAsync(
                    project: projectName,
                    planId: testPlanId,
                    suiteId: testSuiteId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        do
        {
            PagedList<TestSuite> response = await Client
